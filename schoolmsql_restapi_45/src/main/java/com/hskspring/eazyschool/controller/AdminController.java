...
import com.hskspring.eazyschool.repository.CoursesRepository;
...
public class AdminController {
    ...
    public ModelAndView displayCourses(Model model) {
        //List<Courses> courses = coursesRepository.findByOrderByNameDesc(); static sorting Z -> A
        //List<Courses> courses = coursesRepository.findByOrderByName(); static sorting by name

        //List<Courses> courses = coursesRepository.findAll(Sort.by("name").ascending()); dynamic sorting
