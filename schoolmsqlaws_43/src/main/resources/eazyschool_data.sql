...
DELETE FROM person where email = 'admin@email.com';

INSERT INTO `person` (`name`, `email`, `mobile_number`,`pwd`, `role_id`,`created_at`, `created_by`)
    VALUES ('Admin', 'admin@email.com', '3692581478', '$2a$12$go2l8ZCYdbIWmvS9whIB0.Ka/lCEOinwlrJrnzMI9o1KcsPJXFhYC', 1, CURDATE(), 'DBA');

/*RANDOM MESSAGES FOR PAGINATION*/
