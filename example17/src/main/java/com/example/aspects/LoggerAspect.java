...
public class LoggerAspect {
    ...
    public void logException(JoinPoint joinPoint, Exception ex) {
        logger.log(Level.SEVERE, joinPoint.getSignature() + "An exception thrown the help of" +
                " @AfterThrowing happened due to :" + ex.getMessage());
    }

    @AfterReturning(value = "execution(* com.example.services.*.*(..))", returning = "retVal")
    public void logStatus(JoinPoint joinPoint, Objects retVal) {
...
//        logger.log(Level.INFO,joinPoint.getSignature()+ " Methods successfully processed with the status " +
//                retVal.toString());
//    }
}
